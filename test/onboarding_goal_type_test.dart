...
void main() {
  ...
  test('fitness calculator produces goal-specific targets instead of a hardcoded 2000 kcal', () {
    ...
    expect(targets['target_calories'], isNot(2000));
    expect(targets['target_calories'], greaterThan(2000));
    ...
    expect(targets['daily_water_ml'], greaterThan(2000));
  });
}
